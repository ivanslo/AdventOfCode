...
if __name__ == '__main__':
    print("-- tests --")
    print("input: %d => result: %d" % (1, solution(1)))
    print("input: %d => result: %d" % (12, solution(12)))
    print("input: %d => result: %d" % (23, solution(23)))
    print("input: %d => result: %d" % (1024, solution(1024)))
    print("-- solution --")
    print("input: %d => result: %d" % (325489, solution(325489)))
